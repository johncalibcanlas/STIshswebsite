...
<body style="background-color:white">
  ...
  <div class="container-fluid"> 
    ...
    <div class="jumbotron-fluid" style="height:400px;background-image:url(https://ak7.picdn.net/shutterstock/videos/10092530/thumb/7.jpg);background-position:center;background-size:100%;background-repeat:no-repeat; margin-left:65px;margin-top:40px;margin-right:65px;margin-bottom:30px" >
    <br /><br />
        <h2 class="display-2" style="font-size:50px;color:white" align="center">Start your career with STI!</h2><br />
        <h2 class="display-2" style="font-size:20px;color:white" align="center">Eating is a necessity but Cooking is an Art.</h2>

</div>
    <div class="jumbotron text-center">
  <h1>Culinary Arts</h1>
  <p>Food Expo Entries</p> 
</div>
    ...
    <div class="row" style="margin-bottom:100px">
        <div class="col-sm-4 col-md-4">
            <div class="post">
                <div class="post-img-content">
                    <img src="https://i.imgur.com/D6t5SZY.jpg" class="img-responsive" />
                </div>
                <div class="content">
                    
                    <div>
                        A little Party never killed nobody. Held and event with a theme of gatsby, and the name of our event is nouveau. this event showcase our different talents confidence and skills in terms of catering...
                            
                        </div>
                    <br />
                    <div>
                        <a href="https://nethics.wordpress.com/2018/02/20/culinary-arts-hands-on/" class="btn btn-warning btn-sm">Read more</a>
                    </div>
        ...
        <div class="col-sm-4 col-md-4">
            <div class="post">
                <div class="post-img-content">
                    <img src="https://i.imgur.com/N4Dtkxg.jpg" class="img-responsive" />
                </div>
                <div class="content">
                    ...
                    <br />
                    <div>
                        <a href="https://nethics.wordpress.com/2018/02/20/141/" class="btn btn-primary btn-sm">Read more</a>
                    </div>
        ...
        <div class="col-sm-4 col-md-4">
            <div class="post">
                <div class="post-img-content">
                    <img src="https://i.imgur.com/AIVIxOf.jpg" class="img-responsive" />
                </div>
                <div class="content">
                    ...
                    <div>
                       A little Party never killed nobody. Held and event with a theme of gatsby, and the name of our event is nouveau. this event showcase our different talents confidence and skills in terms of catering...
                        ...
                        <br />
                    <div>
                        <a href="https://nethics.wordpress.com/2018/02/20/culinary-arts-hands-on/" class="btn btn-success btn-sm">Read more</a>
                    </div>
                    </div>
                </div>
            </div>
