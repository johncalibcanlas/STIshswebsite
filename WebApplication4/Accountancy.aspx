...
<body style="background-color:white">
  ...
  <div class="container-fluid"> 
    ...
    <div class="jumbotron-fluid" style="height:400px;background-image:url(https://businessfirstfamily.com/wp-content/uploads/2016/04/improve-profit-margin-ratio.jpg);background-position:center;background-size:100%;background-repeat:no-repeat; margin-left:65px;margin-top:40px;margin-right:65px;margin-bottom:30px" >
    <br /><br />
        <h2 class="display-2" style="font-size:50px;color:white;text-align:center">Start your career with STI!</h2><br />
        <h2 class="display-2" style="font-size:20px;color:white;text-align:center"">ACCOUNTING Act. Count. Think.</h2>

</div>
    <div class="jumbotron text-center">
  <h1>Accountancy, Business and Management </h1>
  <p>Wordpress Entries</p> 
</div>
  <div class="container">
    <div class="row" style="margin-bottom:30px">
        <div class="col-sm-4 col-md-4">
            <div class="post">
                <div class="post-img-content">
                    <img src="https://i.imgur.com/n9ccEOB.jpg" class="img-responsive" />
                </div>
                <div class="content">
                    
                    <div>
                        Jema’s Cafeteria Dessert By Jerica Galima, Marisol Dumlao and Aslanie Bundas. A business proposal of Accountancy, Business and Management...
                        </div>
                    <br />
                    <div>
                        <a href="https://nethics.wordpress.com/2018/02/19/65/" class="btn btn-warning btn-sm">Read more</a>
                    </div>
        ...
        <div class="col-sm-4 col-md-4">
            <div class="post">
                <div class="post-img-content">
                    <img src="https://i.imgur.com/vUMWkno.jpg" class="img-responsive" />
                </div>
                <div class="content">

                    <div>
                       Chill'n Eat by Myrlan Flores, Julianne Desiree Ferrer and  Kathleen Ramos. A business proposal of Accountancy, Business and Management...
                        </div>
                    <br />
                    <div>
                        <a href="https://nethics.wordpress.com/2018/02/19/63/" class="btn btn-primary btn-sm">Read more</a>
                    </div>
        ...
        <div class="col-sm-4 col-md-4" style="margin-bottom:30px">
            <div class="post">
                <div class="post-img-content">
                    <img src="https://i.imgur.com/7LB2C0n.jpg" class="img-responsive" />
                </div>
                <div class="content">
 
                    <div>
                       Shainarie by Ronalyn Matias, Gem Marie Cepres and Shaira Reano. A business proposal of Accountancy, Business and Management...
                    </div>
                    <br />
                    <div>
                        <a href="https://nethics.wordpress.com/2018/02/19/67/" class="btn btn-success btn-sm">Read more</a>
                    </div>
                    </div>
